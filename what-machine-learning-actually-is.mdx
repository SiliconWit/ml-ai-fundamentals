...
<PodcastEmbed src="https://open.spotify.com/episode/7eSgZxYuij1pbC6kfQlQJ0?si=NuuZIfWZQeicoHff7UcMFg" />
...
4. **Overfitting means your model is too complex.** It captures noise along with the signal. Reduce complexity, get more data, or add regularization (covered later in the course).
...
Next, in [Linear Regression and Prediction](./linear-regression-prediction), you will move from single-variable polynomial fitting to multi-feature linear regression using scikit-learn. You will build a sensor data pipeline, learn feature scaling, and evaluate your model with proper metrics.
